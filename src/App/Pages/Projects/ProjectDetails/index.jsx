                ...
                <Paper sx={{ p: 8, mb: 6, borderRadius: '4px' }}>
                    <Box display="flex" justifyContent="space-between">
                        <Box>
                            ...
                            <Typography variant="h6" component="div" sx={{ ml: 2, color: `${color.textDark}` }}>Project 1</Typography>
                        </Box>
                        <Box>
                            <Typography variant="subtitle1" sx={{ color: `${color.textLight}` }}>{t('projects.projectDescription')}</Typography>
                            <Typography variant="h6" component="div" sx={{ ml: 2, color: `${color.textDard}` }}>This is Project 1 description</Typography>
                        </Box>
                    </Box>
                </Paper>
            </Box>
